/**
 * RSMExpenses — standalone expense management page for RSM.
 * Shows both team expense approvals and RSM's own personal TA/DA form.
 */
...
export default function RSMExpenses() {
  ...
  return (
    <PortalLayout portalRole={Role.RSM}>
        ...
        actions={
          <div className="flex gap-2">
            <Button
              ...
              data-ocid="rsm-expenses-page.tab-approvals"
            >
              Team Approvals
            </Button>
            <Button
              ...
              data-ocid="rsm-expenses-page.tab-personal"
            >
              My TA/DA
            </Button>
          </div>
      ...
      <PageContent>
                ...
                <td className="px-4 py-3 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <Button
                      ...
                      data-ocid="rsm-expenses-page.approve"
                    >
                    ...
                    <Button
                      ...
                      data-ocid="rsm-expenses-page.reject"
                    >
        ...
        {activeTab === "personal" && <PersonalTaDaForm roleLabel="RSM" />}
      </PageContent>
    </PortalLayout>
  );
}
