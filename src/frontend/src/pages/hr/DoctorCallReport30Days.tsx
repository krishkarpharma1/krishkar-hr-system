...
const HRDoctorCallReport30Days: React.FC = () => {
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <select
          id="hr-mr-select"
          data-ocid="hr_doctor_call_report.select"
          value={selectedMrId}
      ...
      {selectedMrId ? (
        ...
        <div
          data-ocid="hr_doctor_call_report.empty_state"
...
export default HRDoctorCallReport30Days;
