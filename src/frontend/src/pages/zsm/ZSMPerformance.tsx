...
export default function ZSMPerformance() {
  ...
  return (
    <PortalLayout portalRole={Role.ZSM}>
      <PageHeader
        ...
        subtitle={`Zone-wide performance summary for ${currentMonth}`}
      />
      <PageContent>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
          <div className="bg-card border border-border rounded-lg p-4">
            <h3 className="font-display font-semibold text-sm uppercase tracking-wide text-muted-foreground mb-4 flex items-center gap-1.5">
              <BarChart2 className="w-4 h-4" /> Zone-wise Comparison
            </h3>
          ...
          <div className="bg-card border border-border rounded-lg p-4">
            <h3 className="font-display font-semibold text-sm uppercase tracking-wide text-muted-foreground mb-4 flex items-center gap-1.5">
              <TrendingUp className="w-4 h-4" /> MR Activity Trend
            </h3>
        ...
        <div className="bg-card border border-border rounded-lg overflow-hidden">
          <div className="px-4 py-3 border-b border-border">
            <h3 className="font-display font-semibold text-sm text-foreground">
              MR-wise Zonal Breakdown — {currentMonth}
            </h3>
          </div>
