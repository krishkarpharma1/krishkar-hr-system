...
const ALL_QUICK_LINKS = [
  ...
  },
  {
    ...
    desc: "Targets and achievement data by territory and product",
  },
  {
    label: "Audit Trail",
    icon: ShieldAlert,
    to: "/admin/audit-trail",
    desc: "Full audit log of all admin and user actions",
  },
  {
    label: "Recruitment Pipeline",
    icon: Users,
    to: "/admin/recruitment",
    desc: "Candidate pipeline and recruitment status",
  },
  {
    label: "Appraisal Report",
    icon: BookOpen,
    to: "/admin/appraisal",
    desc: "Appraisal cycle summary with KRA scores and grades",
  },
  {
    label: "Chemist Master",
    icon: Building2,
    to: "/admin/chemist-master",
    desc: "View and export chemist records",
  },
  {
    label: "Attendance Reports",
    icon: CalendarDays,
    to: "/admin/attendance-reports",
    desc: "Monthly attendance summary per employee",
  },
  {
    label: "Payroll Reports",
    icon: BarChart2,
    to: "/admin/payroll-reports",
    desc: "Monthly payroll summary for all employees",
  },
  {
    label: "DCR Reports",
    icon: FileText,
    to: "/admin/dcr-report",
    desc: "Daily call reports by employee and territory",
  },
  {
    label: "Expense Reports",
    icon: HandCoins,
    to: "/admin/expense-reports",
    desc: "Expense claims with approval status",
  },
  {
    label: "Doctor Master",
    icon: Stethoscope,
    to: "/admin/doctor-master",
    desc: "Manage and export full doctor database",
  },
  {
    label: "Bulk Export",
    icon: Download,
    to: "/admin/bulk-export",
    desc: "Generate a single Excel file with multiple report sheets",
  },
];
