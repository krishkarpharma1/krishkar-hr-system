...
function tsToDate(ts: bigint): Date {
  // Backend stores date as milliseconds timestamp
...
export default function CompanyHolidayMaster() {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          {holiday && (
                            <span className="text-[8px] text-red-600 font-display truncate px-0.5 max-w-full">
                              H
                            </span>
                          )}
                        </div>
